  ...
  public $del_footer_img_3;
    ...
    public function rules()
    {
        return [
            ...
            [['text'], 'string'],
            [['title', 'img_to_page_category', 'img1', 'img2', 'img3', 'pdf1', 'pdf2', 'delivery', 'description', 'keywords', 'tags', 'footer_img_1', 'footer_img_2', 'footer_img_3', 'footer_video'], 'string', 'max' => 255],
