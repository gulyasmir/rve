...
<div class="index-form">
    ...
    <p>Для корректного отображения фото должно быть большими - 1900 на 845 пикселей</p>
              <?php
            ...
            ?>
  <?= $form->field($model, 'file1')->fileInput()->label('Картинка в шапку') ?>

    <?= $form->field($model, 'description')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'keywords')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'title1')->widget(TinyMce::className(), [
            'options' => ['rows' => 6],
            'language' => 'ru',
            'clientOptions' => [
            'plugins' => [
    ...
    <?= $form->field($model, 'text2')->widget(TinyMce::className(), [
        ...
        <?=  $form->field($model, 'icon1text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
        ...
        <?= $form->field($model, 'icon2text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
        ...
        <?= $form->field($model, 'icon3text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
        ...
        <?= $form->field($model, 'icon4text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
        ...
        <?= $form->field($model, 'icon5text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
        ...
        <?= $form->field($model, 'icon6text')->widget(TinyMce::className(), [
                'options' => ['rows' => 6],
                'language' => 'ru',
                'clientOptions' => [
                'plugins' => [
