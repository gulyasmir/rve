...
<h3>Фото и видео для футера</h3>
    ...
    ?>
    <?= $form->field($model, 'file_footer_img_1')->fileInput()->label('фото внизу страницы 1') ?>
  ...
  ?>
  <?= $form->field($model, 'file_footer_img_2')->fileInput()->label('фото внизу страницы 2') ?>
  ...
  ?>
  <?= $form->field($model, 'file_footer_img_3')->fileInput()->label('фото внизу страницы 3') ?>
