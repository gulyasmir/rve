...
class Index extends \yii\db\ActiveRecord
{
  ...
  public $del_img1;
    ...
    {
        return [
            [['title', 'description', 'keywords', 'title1', 'text1', 'title2', 'text2', 'text3', 'icon1text', 'icon2text', 'icon3text', 'icon4text', 'icon5text', 'icon6text'], 'required'],
            [['title1', 'text1', 'title2', 'text2', 'text3', 'icon1text', 'icon2text', 'icon3text', 'icon4text', 'icon5text', 'icon6text'], 'string'],
            [['title', 'description', 'keywords', 'foto'], 'string', 'max' => 255],
