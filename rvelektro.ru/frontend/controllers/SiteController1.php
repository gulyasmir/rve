    ...
    public function actionResult()
     {
       ...
       $customemail = Yii::$app->request->post('customemail');
...
//    }
    ...
    public function actionCategory($id)
    {
      ...
      $main_parent_category = Category::find()->where(['id'=>$query->parent_id])->one();

      $podcats = Category::find()->where(['parent_id'=>$id])->all();
